...
var ops = unwrapExports(lib);
var lib_1 = lib.ops;
var lib_2 = lib.getBatchToken;
var lib_3 = lib.canMutate;
var lib_4 = lib.getImmutableOps;
...
function clauseFiltersByAttribute(_ref, attribute) {
    ...
    if ((typeof payload === 'undefined' ? 'undefined' : _typeof$1(payload)) !== 'object') {
        /**
...
var QuerySet = function () {
    ...
    _createClass(QuerySet, [{
        ...
        value: function filter(lookupObj) {
             ...
             */
            var normalizedLookupObj = (typeof lookupObj === 'undefined' ? 'undefined' : _typeof$1(lookupObj)) === 'object' ? mapValues_1(lookupObj, normalizeEntity) : lookupObj;
...
var _defineProperty$3 = unwrapExports(defineProperty$4);
...
var Session = function () {
    ...
    function Session(schema, db, state, withMutations, batchToken) {
        ...
        this.batchToken = batchToken || lib_2();
    ...
    _createClass(Session, [{
        ...
        get: function get() {
            ...
            return this.sessionBoundModels.filter(function (_ref) {
                ...
                return _extends$3({}, result, _defineProperty$3({}, modelName, _this2.getDataForModel(modelName).accessedInstances));
            }, {});
        }
    }, {
...
function forwardsManyToOneDescriptor(fieldName, declaredToModelName) {
    return {
        ...
        set: function set(value) {
            this.update(_defineProperty$3({}, fieldName, normalizeEntity(value)));
        }
    };
}
...
function backwardsOneToOneDescriptor(declaredFieldName, declaredFromModelName) {
    return {
        get: function get() {
            ...
            return DeclaredFromModel.get(_defineProperty$3({}, declaredFieldName, this.getId()));
        },
        set: function set() {
...
function backwardsManyToOneDescriptor(declaredFieldName, declaredFromModelName) {
    return {
        get: function get() {
            ...
            return DeclaredFromModel.filter(_defineProperty$3({}, declaredFieldName, this.getId()));
        },
        set: function set() {
...
function manyToManyDescriptor(declaredFromModelName, declaredToModelName, throughModelName, throughFields, reverse) {
    return {
        get: function get() {
            ...
            var throughQs = ThroughModel.filter(_defineProperty$3({}, thisReferencingField, thisId));
            ...
            qs.add = function add() {
                ...
                idsToAdd.forEach(function (id) {
                    ...
                    return ThroughModel.create((_ThroughModel$create = {}, _defineProperty$3(_ThroughModel$create, otherReferencingField, id), _defineProperty$3(_ThroughModel$create, thisReferencingField, thisId), _ThroughModel$create));
                });
            };
...
function getByIdQuery(modelInstance) {
    ...
    return {
        ...
        clauses: [{
            type: FILTER,
            payload: _defineProperty$3({}, idAttribute, modelInstance.getId())
        }]
    };
}
...
var Model = function () {
    ...
    _createClass(Model, [{
        ...
        value: function set(propertyName, value) {
            this.update(_defineProperty$3({}, propertyName, value));
        }
        ...
        value: function update(userMergeObj) {
            ...
            var mergeObj = _extends$3({}, userMergeObj);
            ...
            var mergedFields = _extends$3({}, this._fields, mergeObj);
        ...
        value: function _onDelete() {
            ...
            for (var key in virtualFields) {
                ...
                if (field instanceof ManyToMany) {
                    ...
                    if (relatedQs.exists()) {
                        relatedQs.update(_defineProperty$3({}, field.relatedName, null));
                    }
        ...
        get: function get() {
            ...
            // eslint-disable-next-line no-underscore-dangle
            return ThisModel._findDatabaseRows(_defineProperty$3({}, ThisModel.idAttribute, this.getId()))[0];
        }
        ...
        value: function create(userProps) {
            ...
            var props = _extends$3({}, userProps);
        ...
        value: function withId(id) {
            return this.get(_defineProperty$3({}, this.idAttribute, id));
        }
        ...
        value: function idExists(id) {
            return this.exists(_defineProperty$3({}, this.idAttribute, id));
        }
...
var Table = function () {
    ...
    _createClass(Table, [{
        ...
        value: function getEmptyState() {
            ...
            return _ref = {}, _defineProperty$3(_ref, this.arrName, []), _defineProperty$3(_ref, this.mapName, {}), _defineProperty$3(_ref, 'meta', {}), _ref;
        }
    }, {
        key: 'setMeta',
        ...
        value: function insert(tx, branch, entry) {
            ...
            var nextState = ops.batch.merge(batchToken, (_ops$batch$merge2 = {}, _defineProperty$3(_ops$batch$merge2, this.arrName, ops.batch.push(batchToken, id, workingState[this.arrName])), _defineProperty$3(_ops$batch$merge2, this.mapName, ops.batch.merge(batchToken, _defineProperty$3({}, id, finalEntry), workingState[this.mapName])), _ops$batch$merge2), workingState);
        ...
        value: function _delete(tx, branch, rows) {
            ...
            return ops.batch.merge(batchToken, (_ops$batch$merge3 = {}, _defineProperty$3(_ops$batch$merge3, arrName, ops.batch.filter(batchToken, function (id) {
                return !includes_1(idsToDelete, id);
            }, branch[arrName])), _defineProperty$3(_ops$batch$merge3, mapName, ops.batch.omit(batchToken, idsToDelete, branch[mapName])), _ops$batch$merge3), branch);
        }
    }]);
...
unwrapExports(lib$1);
var lib_1$1 = lib$1.defaultMemoize;
var lib_2$1 = lib$1.createSelectorCreator;
var lib_3$1 = lib$1.createStructuredSelector;
var lib_4$1 = lib$1.createSelector;
...
function createSelector(orm) {
    ...
    return lib_2$1(memoize$1, undefined, orm).apply(undefined, args);
}
            ...
            forOwn_1(fields, function (fieldInstance, fieldName) {
                ...
                if (fieldInstance.through) {
                    ...
                    Through.fields = (_Through$fields = {
                        id: attr()
                    }, _defineProperty$3(_Through$fields, fromFieldName, new ForeignKeyClass(thisModelName)), _defineProperty$3(_Through$fields, toFieldName, new ForeignKeyClass(toModelName)), _Through$fields);
...
export { index as reducer, index$1 as saga, index$3 as model, index$4 as router };
